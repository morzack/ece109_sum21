;;;This test checks colliding with an
;;;apple, followed by non-collision advances
;;;until the grow count returns to zero.
	...
	JSRR R5
	JSRR R5
	JSRR R5				; move up 9 times
	STR R3, R0, 4		; move right
	JSRR R5				; move right 1 time
...
TEST_SNAKE:
        ...
        .FILL x3     ; Direction +4
        .FILL x8AA8  ; Color +5
        .FILL 40     ; Start of Position Queue +6
        .FILL 20
        .BLKW 254 ;2x128-2
